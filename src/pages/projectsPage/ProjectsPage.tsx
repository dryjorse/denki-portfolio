...
import ProjectsCount from "../../components/projectsPage/projectsCount/ProjectsCount";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${isLaptop ? bannerTwoImg : bannerImg})`,
        }}
      >
      ...
      <Projects data={data} isLoading={!data?.results || isFetching} />
    </>
  );
};
